...
export function ActivityTab() {
  ...
  }, [timeRange, channel, direction, showToast]);
  ...
  // ============================================================
  // ACTIVITY CLICK HANDLER (for future details)
  // ============================================================

  const handleActivityClick = (activity) => {
    console.log('🖱️ Activity clicked:', activity);
    // TODO: Open activity detail modal/page
    showToast(`Activity from ${activity.personName} (details coming soon)`, 'info');
  };
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
          ...
          <p className="text-sm text-gray-400 mt-1">
            {channel !== 'all' || direction !== 'all' ? 'Try changing your filters' : 'No messages found for this time period'}
          </p>
        </div>
      )}
